...
// If borderSize is non-zero, a transparent border of the given size will also
// be added
...
- (UIImage *)roundedCornerImage:(NSInteger)cornerSize
  ...
  [self addRoundedRectToPath:CGRectMake(borderSize, borderSize,
  ...
  // Draw the image to the context; the clipping path will make anything outside
  // the rounded rect transparent
...
// Adds a rectangular path to the given context and rounds its corners by the
// given extents
// Original author: Björn Sållarp. Used with permission. See:
// http://blog.sallarp.com/iphone-uiimage-round-corners/
- (void)addRoundedRectToPath:(CGRect)rect
